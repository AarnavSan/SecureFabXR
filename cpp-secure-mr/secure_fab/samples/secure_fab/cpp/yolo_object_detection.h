...
namespace SecureMR {
    ...
    protected:
        ...
        void CreateSecureMrDetectionCheckPipeline();
        ...
        void RunSecureMrDetectionCheckPipeline();
        ...
        void RenderText(const std::shared_ptr<Pipeline>& pipeline,
                        const std::shared_ptr<PipelineTensor>& textArray0,
                        const std::shared_ptr<PipelineTensor>& pointXYZ0,
                        ...
                        const std::shared_ptr<PipelineTensor>& detectedClass);
    ...
    private:
        ...
        std::shared_ptr<Pipeline> m_secureMrDetectionCheckPipeline;
        ...
        std::shared_ptr<GlobalTensor> detectionFlagGlobal;  // ADD THIS
        ...
        // Target class to detect (COCO class IDs)
        // 39 = bottle, 41 = cup, 76 = scissors, 73 = book, 66 = keyboard
        static constexpr int TARGET_CLASS_ID = 76;  // Change this to desired class
        int lastDetectedClass_ = -1;
